  ...
  return (
    ...
    >
      ...
      <article className='space-y-2'>
        <Link className='block max-w-lg mx-auto text-base text-white text-center py-4 px-8 rounded-md bg-blue-500 hover:bg-blue-400 active:bg-blue-600 font-medium' href={{ pathname: '/admin/new-blog' }} >Create new blog</Link>
